...
const MieStableSwapFactory = artifacts.require('stable-swap/contracts/MieStableSwapFactory.sol')
const MieStableSwapLPFactory = artifacts.require('stable-swap/contracts/MieStableSwapLPFactory.sol')
const MieStableSwapTwoPoolDeployer = artifacts.require('stable-swap/contracts/MieStableSwapTwoPoolDeployer.sol')
const MieStableSwapThreePoolDeployer = artifacts.require('stable-swap/contracts/MieStableSwapThreePoolDeployer.sol')
const MieStableSwapTwoPool = artifacts.require('stable-swap/contracts/MieStableSwapTwoPool.sol')
const MieStableSwapThreePool = artifacts.require('stable-swap/contracts/MieStableSwapThreePool.sol')
const MieStableSwapTwoPoolInfo = artifacts.require('stable-swap/contracts/utils/MieStableSwapTwoPoolInfo.sol')
const MieStableSwapThreePoolInfo = artifacts.require('stable-swap/contracts/utils/MieStableSwapThreePoolInfo.sol')
const MieStableSwapInfo = artifacts.require('stable-swap/contracts/utils/MieStableSwapInfo.sol')
const LPToken = artifacts.require('stable-swap/contracts/MieStableSwapLP.sol')
...
const MieFactory = artifacts.require('exchange-protocol/contracts/MieFactory.sol')
const MiePair = artifacts.require('exchange-protocol/contracts/MiePair.sol')
const MieRouter = artifacts.require('exchange-protocol/contracts/MieRouter.sol')
...
contract('SmartRouter', ([admin, bob, carol]) => {
  ...
  before(async () => {
    ...
    /** Create Stable Swap */
    stableSwapLPFactory = await MieStableSwapLPFactory.new({ from: admin })
    stableSwap2PoolDeployer = await MieStableSwapTwoPoolDeployer.new({ from: admin })
    stableSwap3PoolDeployer = await MieStableSwapThreePoolDeployer.new({ from: admin })
    stableSwapFactory = await MieStableSwapFactory.new(
    ...
    stableSwap2PoolInfo = await MieStableSwapTwoPoolInfo.new({ from: admin })
    stableSwap3PoolInfo = await MieStableSwapThreePoolInfo.new({ from: admin })
    stableSwapPoolInfo = await MieStableSwapInfo.new(stableSwap2PoolInfo.address, stableSwap3PoolInfo.address, {
      from: admin,
    })
    ...
    stable2Pool_BUSD_USDC = await MieStableSwapTwoPool.at(stable2PoolInfo.swapContract)
    ...
    stable2Pool_WBNB_BUSD = await MieStableSwapTwoPool.at(stable2PoolInfo_WBNB_BUSD.swapContract)
    ...
    stable3Pool_BUSD_USDC_USDT = await MieStableSwapThreePool.at(stable3PoolInfo.swapContract)
