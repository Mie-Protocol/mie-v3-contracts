...
import '@Mieswap/v3-core/contracts/libraries/TickBitmap.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IMieV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IMieV3Pool;
    ...
    */
    ...
    function MieV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes memory path) external view override {
        ...
        IMieV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        returns (uint256 amountOut, uint160 sqrtPriceX96After, uint32 initializedTicksCrossed, uint256 gasEstimate)
    {
        ...
        IMieV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
