...
import './interfaces/IMieStableSwap.sol';
import './interfaces/IMieStableSwapLP.sol';
import './interfaces/IMieStableSwapDeployer.sol';
import './interfaces/IMieStableSwapLPFactory.sol';

contract MieStableSwapFactory is Ownable {
    ...
    IMieStableSwapLPFactory public immutable LPFactory;
    IMieStableSwapDeployer public immutable SwapTwoPoolDeployer;
    IMieStableSwapDeployer public immutable SwapThreePoolDeployer;
     ...
     */
    constructor(
        IMieStableSwapLPFactory _LPFactory,
        IMieStableSwapDeployer _SwapTwoPoolDeployer,
        IMieStableSwapDeployer _SwapThreePoolDeployer
    ) {
    ...
    function createSwapPair(
        ...
        IMieStableSwapLP(LP).setMinter(swapContract);
    ...
    function addPairInfo(address _swapContract) external onlyOwner {
        IMieStableSwap swap = IMieStableSwap(_swapContract);
