...
describe('MieV3Pool', () => {
  ...
  let pool0: MockTimeMieV3Pool
  let pool1: MockTimeMieV3Pool
  ...
  let swapTargetCallee: TestMieV3Callee
  let swapTargetRouter: TestMieV3Router
