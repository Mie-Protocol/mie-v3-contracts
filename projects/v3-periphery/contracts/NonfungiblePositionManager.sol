...
import '@Mieswap/v3-core/contracts/libraries/FixedPoint128.sol';
...
/// @title NFT positions
/// @notice Wraps Mie V3 positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the Mie position
    struct Position {
    ...
    ) ERC721Permit('Mie V3 Positions NFT-V1', 'PCS-V3-POS', '1') PeripheryImmutableState(_deployer, _factory, _WETH9) {
