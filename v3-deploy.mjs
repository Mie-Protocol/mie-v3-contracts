...
await $`yarn workspace @Mieswap/v3-core run hardhat run scripts/deploy.ts --network ${network}`

await $`yarn workspace @Mieswap/v3-periphery run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @Mieswap/smart-router run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @Mieswap/masterchef-v3 run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @Mieswap/v3-lm-pool run hardhat run scripts/deploy2.ts --network ${network}`
